 ...
 * 
 * Usage:
 *   ACTALUMEN_API_KEY=al_xxx npx tsx examples/test-verification.ts <pdf-path> [template-id]
 */

import { ActaLumenClient, waitForDocumentReady, waitForJobReady, ActaLumenError } from "../src/index.js";
import fs from "fs";
...
async function main() {
  ...
  console.log("=== ActaLumen Verification Test ===\n");

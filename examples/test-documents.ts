 ...
 * 
 * Usage:
 *   ACTALUMEN_API_KEY=al_xxx npx tsx examples/test-documents.ts [pdf-path]
 */

import { ActaLumenClient, waitForDocumentReady, downloadToBuffer, ActaLumenError } from "../src/index.js";
import fs from "fs";
...
async function main() {
  ...
  console.log("=== ActaLumen Document Operations Test ===\n");
